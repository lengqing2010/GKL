...
<div id="divGvw" class='jq_ms_div' runat ="server" style="overflow:scroll ; height:294px;margin-left:0px; width:1020px; margin-top :0px; border-collapse :collapse ;">
      <table class='ms_input' style="width:2418px" cellpadding="0" cellspacing="0">
          <tr>
              <td style="width:210px;">
              ...
              <td style="width:210px;">
              <asp:TextBox ID="tbxKjExplain" class="jq_kj_explain_ipt" runat="server" maxLength="200" style="width:204px;"></asp:TextBox>
          </td>
              <td style="width:210px;">
   ...
   <asp:GridView CssClass ="jq_ms" Width="2418px"  runat="server" ID="gvMs" EnableTheming="True" ShowHeader="False" AutoGenerateColumns="False" BorderColor="black" style=" margin-top :-1px; " TabIndex="-1" >
      <Columns>
          ...
          <asp:TemplateField><ItemTemplate ><%#Eval("kj_explain")%></ItemTemplate><ItemStyle Width="210px" HorizontalAlign="Left" CssClass="jq_kj_explain" /></asp:TemplateField>
