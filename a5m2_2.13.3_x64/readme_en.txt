-------------------------------------------------------------------
Software   : A5:SQL Mk-2 Version 2.13.3
...
Website   : http://www.wind.sannet.ne.jp/m_matsu/
File      : x86 edition : a5m2_2.13.3_x86.zip
            x64 edition : a5m2_2.13.3_x64.zip
            x86 edition(Read-only edition) : a5m2_2.13.3_x86_r.zip
            x64 edition(Read-only edition) : a5m2_2.13.3_x64_r.zip
-------------------------------------------------------------------
...
[FILE CONTENTS]
  The archive file contains the following files.
    ...
    A5M2.ENG                          English (U.S.) Language resource.
...
[About used program components]
  ...
  ・UniDAC Ver 7.1.4
      Devart
      Commercial License
  ・ファイルドロップコンポーネント v1.00  
    (Flie drop components v1.00)
      米田 昌司 ( NORG1964 )
